    ...
    filter(0)
{
    ...
    ui->labelSpendableText->setText("<html><img src=':icons/spendable' width=16 height=16 border=0 align='bottom'> 可使用艾伦币:</html>");
    ui->labelStakeText->setText("<html><img src=':icons/staking' width=16 height=16 border=0 align='bottom'> 权益累积:</html>");
    ui->labelUnconfirmedText->setText("<html><img src=':icons/unconfirmed' width=16 height=16 border=0 align='bottom'> 未确认的艾伦币:</html>");
    ui->labelTotalText->setText("<html><img src=':icons/total' width=16 height=16 border=0 align='bottom'> 艾伦币余额:</html>");

    QUrl statsUrl("http://shop.m.jd.com/?shopId=99371");
    ...
    QUrl valueUrl("http://ailuncoin.com/trade");
    ...
    QUrl tickerUrl(QString(walletUrl).append("paoma/"));
    ...
    ui->labelWalletStatus->setText("(" + tr("等待同步中") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("等待同步中") + ")");
